...
import { gitHubCallback, login, logout, register, restorePassword, forgotPassword, restorePasswordToken } from "../controllers/session.controller.js";
...
sessionRouter.get("/restore-password/:token", restorePasswordToken);
